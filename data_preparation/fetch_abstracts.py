"""
Note: this code is copied from https://gitlab.com/TIBHannover/orkg/orkg-bioassays-semantification/-/blob/master/services/metadata.py
it is not my code, the code belongs to Omar Arab Oghli
"""
import requests
import time
import re
...
class MetadataService:
    ...
    def by_title(self, title):
        return self.crossRef.by_title(title) or self.semanticScholar.by_title(title)
